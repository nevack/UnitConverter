...
public enum EUnitCategory {
    ...
    AREA(R.string.area, R.drawable.ic_area, R.color.material_red_500, AreaConverter.class),
    ...
    OTHER(R.string.other, R.drawable.ic_other, R.color.material_red_500, OtherConverter.class);
