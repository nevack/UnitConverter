...
import dev.nevack.unitconverter.feature.converter.databinding.DisplayBinding
import dev.nevack.unitconverter.model.ConversionUnit
import kotlin.math.pow
import kotlin.math.sqrt

internal class ConverterDisplayView
    @JvmOverloads
    constructor(
        context: Context,
        ...
        init {
            ...
            binding =
                DisplayBinding.inflate(LayoutInflater.from(context), this).apply {
